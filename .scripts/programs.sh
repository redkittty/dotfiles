...
select choice in "${options[@]}"; do
  case $choice in
    "Yes")
      ...
      sudo pacman -Syy doas dash pcmanfm htop zsh git steam mpv rust rust-analyzer neovim python3 kitty qbittorrent firefox bluez bluez-utils base-devel man-db ttf-font-awesome noto-fonts-emoji neofetch
      # Dash Setup
