...
select choice in "${options[@]}"; do
  case $choice in
    "Yes")
      ...
      sudo pacman -Syy emacs fish eza doas dash pcmanfm htop zsh git steam mpv unzip rust rust-analyzer neovim python3 kitty qbittorrent firefox bluez bluez-utils base-devel man-db ttf-font-awesome lua_language_server noto-fonts-emoji hyfetch || echo "This script only supports Arch-based Distros"
